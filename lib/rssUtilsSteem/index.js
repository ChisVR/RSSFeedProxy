            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.prev = 0;
                        _context.next = 3;
                        return steem.api.callAsync('condenser_api.get_accounts', [[username]]);
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _context4.next = 4;
                        return steem.api.callAsync('condenser_api.get_account_history', [voter, -1, 1000]);
...
var getDiscussionsByCreated = (0, _util.promisify)(steem.api.getDiscussionsByCreated);
var getDiscussionsByFeed = (0, _util.promisify)(steem.api.getDiscussionsByFeed);
var getDiscussionsByBlog = (0, _util.promisify)(steem.api.getDiscussionsByBlog);
var getDiscussionsByHot = (0, _util.promisify)(steem.api.getDiscussionsByHot);
var getDiscussionsByTrending = (0, _util.promisify)(steem.api.getDiscussionsByTrending);
var getDiscussionsByPromoted = (0, _util.promisify)(steem.api.getDiscussionsByPromoted);
var getDiscussionsByComments = (0, _util.promisify)(steem.api.getDiscussionsByComments);
var getDiscussionsByAuthorBeforeDate = (0, _util.promisify)(steem.api.getDiscussionsByAuthorBeforeDate);
