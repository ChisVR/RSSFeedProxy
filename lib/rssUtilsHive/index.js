            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.prev = 0;
                        _context.next = 3;
                        return hive.api.callAsync('condenser_api.get_accounts', [[username]]);
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        _context4.next = 4;
                        return hive.api.callAsync('condenser_api.get_account_history', [voter, -1, 1000]);
...
var getDiscussionsByCreated = (0, _util.promisify)(hive.api.getDiscussionsByCreated);
var getDiscussionsByFeed = (0, _util.promisify)(hive.api.getDiscussionsByFeed);
var getDiscussionsByBlog = (0, _util.promisify)(hive.api.getDiscussionsByBlog);
var getDiscussionsByHot = (0, _util.promisify)(hive.api.getDiscussionsByHot);
var getDiscussionsByTrending = (0, _util.promisify)(hive.api.getDiscussionsByTrending);
var getDiscussionsByPromoted = (0, _util.promisify)(hive.api.getDiscussionsByPromoted);
var getDiscussionsByComments = (0, _util.promisify)(hive.api.getDiscussionsByComments);
var getDiscussionsByAuthorBeforeDate = (0, _util.promisify)(hive.api.getDiscussionsByAuthorBeforeDate);
